    ...
    return (
        <div className='rant-body'>
            <div className='rant-title'>
                <div className='rant-title-text'><h1>{data.title}</h1></div>
                <div className='more-icon'><IconButton><MoreVertIcon style={{ color: 'white' }} /></IconButton></div>
            </div>
            <div className='rant-credits'>
                <div className='rant-credits-img'><img alt = {data.handle} src={data.imageURL}></img></div>
